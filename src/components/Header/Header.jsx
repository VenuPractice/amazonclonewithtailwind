  ...
  return (
    <div className="w-full sticky top-0 z-50">
     ...
     bg-white border-[1px] border-amazon_blue text-black p-2 flex-col gap-1"
        ...
        {/*===================Sign in Bar End Here============================*/}

        {/*===================Returns and orders logo Here============================*/}
        <div
        ...
        {/*===================Returns and orders logo End Here============================*/}

        {/*===================Cart logo start Here============================*/}
